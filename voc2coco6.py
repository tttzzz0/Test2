...
#     # 通过txt文件生成
#     voc_data_dir = "../VOCData/"
#     json_save_path = "../VOCData_COCO2/voc2007val.json"
#     parseXmlFiles_by_txt(voc_data_dir, json_save_path, "val")

    # # 通过文件夹生成
    ann_path = "E:\PycharmProjects\detr-main\VOC2007\Annotations_val_1"
    json_save_path = r"E:\PycharmProjects\detr-main\VOC2007\val.json"
